    ...
    <footer className={styles.footer}>
      <div className={styles.footerContainer}>
        <div className={styles.footerColumn}>
          <h3 className={styles.footerTitle}>Oboe Store</h3>
          <p className={styles.footerDescription}>
            Tu tienda de confianza para productos de calidad. Ofrecemos los mejores servicios y atención personalizada.
          </p>
        ...
        <div className={styles.footerColumn}>
          ...
          <ul className={styles.footerLinks}>
            <li><Link to="/nosotros" className={styles.footerLink}>Acerca de Nosotros</Link></li>
        ...
        <div className={styles.footerColumn}>
          ...
          <ul className={styles.contactInfo}>
            <li className={styles.contactItem}>
              ...
              <span>Av. Siempre Viva. CABA. Argentina</span>
            </li>
            <li className={styles.contactItem}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path>
              </svg>
              <a href="tel:+543414567890" className={styles.contactLink}>+5401143453</a>
            </li>
            <li className={styles.contactItem}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              ...
              <a href="mailto:info@oboestore.com" className={styles.contactLink}>info@oboestore.com</a>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className={styles.footerBottom}>
        <p className={styles.copyright}>
          © {anioActual} Oboe Store. Todos los derechos reservados.
        </p>
        <p className={styles.madeWith}>
          Build with ❤️ by MusicDev
        </p>
      </div>
    </footer>
  );
